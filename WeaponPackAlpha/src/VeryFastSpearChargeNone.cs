...
// Type: CustomWeaponSpeed.VeryFastSpearChargeNone
...
{
  internal class VeryFastSpearChargeNone : Item
  {
      ...
      EntitySelection entitySel)
    {
      ...
      if (byEntity.World.Side == EnumAppSide.Client)
      {
        ...
        modelTransform.Translation.Set(-0.1f * num3, num6 * 0.4f, (float) (-(double) num3 * 0.800000011920929 * 2.5999999046325684));
        modelTransform.Rotation.Set((float) (-(double) num3 * 1.0), num3 * 30f, (float) (-(double) num3 * 30.0));
