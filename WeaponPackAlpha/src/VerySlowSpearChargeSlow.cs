...
// Type: CustomWeaponSpeed.VerySlowSpearChargeSlow
...
{
  internal class VerySlowSpearChargeSlow : Item
  {
      ...
      EntitySelection entitySel)
    {
      ...
      float num2 = Math.Min(1.2f, 20f * Math.Max(0.0f, secondsPassed - 0.4f));
      ...
      return (double) secondsPassed < 1.15; // spike dagger, bone trident
    }
