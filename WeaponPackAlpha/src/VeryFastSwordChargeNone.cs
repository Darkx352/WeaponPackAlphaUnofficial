...
// Type: CustomWeaponSpeed.VeryFastSwordChargeNone
...
{
  internal class VeryFastSwordChargeNone : Item
  {
      ...
      EntitySelection entitySel)
    {
      ...
      float num2 = Math.Min(1.2f, 20f * Math.Max(0.0f, secondsPassed - 0.0f));
      if (byEntity.World.Side == EnumAppSide.Client)
      {
        ...
        Math.Max(0.0f, num4 - num5);
        modelTransform.Translation.Set(-1.4f * num3, 0.0f, (float) (-(double) num3 * 0.800000011920929 * 2.5999999046325684));
        modelTransform.Rotation.Set((float) (-(double) num3 * 90.0), 0.0f, num3 * 10f);
